...
public class Drivetrain extends SubsystemBase {
    ...
    public static final double kMaxPossibleSpeed = 4.0;
        ...
        try {
            ...
            AutoBuilder.configure(
                ...
                new PPHolonomicDriveController( // HolonomicPathFollowerConfig
                        new PIDConstants(DriveTrain.drivePID[0], // Translation PID constants
                            DriveTrain.drivePID[1],
                            DriveTrain.drivePID[2]), 
                        new PIDConstants(DriveTrain.turnPID[0], // Rotation PID constants
                            DriveTrain.turnPID[1],
                            DriveTrain.turnPID[2]) 
                ),
                ppConfig,
                () -> {
    ...
    public void driveChassisSpeeds(ChassisSpeeds chassisSpeeds) {
        ...
        SwerveDriveKinematics.desaturateWheelSpeeds(swerveModuleStates, Drivetrain.kMaxPossibleSpeed);
